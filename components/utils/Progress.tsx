...
const Progress = () => {
	...
	return (
		<div
			...
			<div
				className="fixed top-0 left-0 h-1 w-full bg-pink-200 transition-all"
				style={{
					width: `${state.progress * 100}%`,
				}}>
				<div className="absolute right-0 block h-full w-24 -translate-y-1 rotate-3 opacity-100 shadow-md shadow-blue-400"></div>
			</div>
		</div>
	);
};
